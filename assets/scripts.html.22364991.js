...
Hello World!
`)])],-1);function $(A,C){const s=o("RouterLink"),c=o("ExternalLinkIcon");return l(),d("div",null,[h,u,_,e("p",null,[g,m,f,n(s,{to:"/book/commands/source.html"},{default:a(()=>[x]),_:1}),b]),w,e("p",null,[v,k,y,N,q,n(s,{to:"/book/types_of_data.html#groups"},{default:a(()=>[S]),_:1}),T]),L,e("p",null,[I,e("a",V,[W,n(c)]),z,B,E]),H,O])}var R=r(p,[["render",$],["__file","scripts.html.vue"]]);export{R as default};
