...
<span class="token punctuation">}</span>
    ...
    <span class="token builtin class-name">let</span> val <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token variable">$config</span> <span class="token operator">|</span> get -i hooks.env_change.<span class="token environment constant">PWD</span><span class="token punctuation">)</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
    ...
    <span class="token punctuation">]</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre></div>`,24);function w(L,S){const c=p("ExternalLinkIcon"),o=p("RouterLink");return r(),i("div",null,[k,a("p",null,[d,a("a",h,[g,s(c)]),v,f,b,_,m]),$,a("p",null,[x,s(o,{to:"/zh-CN/book/configuration.html"},{default:e(()=>[q]),_:1}),E]),P,a("p",null,[y,A,D,s(o,{to:"/zh-CN/book/environment.html#%E4%BB%8E%E8%87%AA%E5%AE%9A%E4%B9%89%E5%91%BD%E4%BB%A4%E4%B8%AD%E5%AE%9A%E4%B9%89%E7%8E%AF%E5%A2%83%E5%8F%98%E9%87%8F"},{default:e(()=>[W]),_:1}),B]),N])}var R=l(u,[["render",w],["__file","hooks.html.vue"]]);export{R as default};
