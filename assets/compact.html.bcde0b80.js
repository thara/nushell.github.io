import{_ as a,o as e,c as s,e as n}from"./app.420e319b.js";const o={},t=n(`<p>This command allows us to filters out rows with empty columns. Other commands are capable of feeding <code>compact</code> with their output through pipelines.</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token punctuation">[</span>input-command<span class="token punctuation">]</span> <span class="token operator">|</span> compact <span class="token punctuation">[</span>column-name<span class="token punctuation">]</span>
