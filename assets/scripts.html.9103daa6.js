import{_ as e,o as t,c as a,e as s}from"./app.22fee913.js";const n={},i=s(`<h1 id="scripts" tabindex="-1"><a class="header-anchor" href="#scripts" aria-hidden="true">#</a> Scripts</h1><p>In Nushell, you can write and run scripts in the Nushell language. To run a script, you pass it as an argument to the <code>nu</code> commandline application.</p><div class="language-text ext-text"><pre class="language-text"><code>&gt; nu myscript.nu
