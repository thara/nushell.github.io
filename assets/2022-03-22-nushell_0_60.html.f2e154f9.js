import{_ as r,o as s,c as i,a as t,b as n,d as e,e as o,r as d}from"./app.79ccc45b.js";var l="/assets/0_60_completions.c220d6a2.gif",c="/assets/0_60_ls_colors.adedeec5.png",h="/assets/0_59_1_for_multiline_indicator.4d6a3a0e.png",u="/assets/0_59_1_ls_gridc.749a3287.png",p="/assets/0_60_miette.e8ce378d.png",g="/assets/0_60_0_completions_internal.afc63983.gif",m="/assets/0_60_0_history.ab361b1d.gif",f="/assets/0_60_0_history_complete.aedd5537.gif";const w={},b=e("Before we begin, as the Russian invasion of Ukraine still continues to threaten lives, "),y={href:"https://war.ukraine.ua",target:"_blank",rel:"noopener noreferrer"},v=e("here"),x=e(" are ways you can help."),_=t("h1",{id:"nushell-0-60",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#nushell-0-60","aria-hidden":"true"},"#"),e(" Nushell 0.60")],-1),k=t("p",null,"Nushell, or Nu for short, is a new shell that takes a modern, structured approach to your commandline. It works seamlessly with the data from your filesystem, operating system, and a growing number of file formats to make it easy to build powerful commandline pipelines.",-1),N=t("p",null,"Today, we're releasing a beta release of 0.60 of Nu. This is an enormous release, with lots of changes across all aspects of Nushell.",-1),q=t("h1",{id:"where-to-get-it",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#where-to-get-it","aria-hidden":"true"},"#"),e(" Where to get it")],-1),T=e("Nu 0.60 is available as "),$={href:"https://github.com/nushell/nushell/releases/tag/0.60.0",target:"_blank",rel:"noopener noreferrer"},A=e("pre-built binaries"),B=e(" or from "),M={href:"https://crates.io/crates/nu",target:"_blank",rel:"noopener noreferrer"},W=e("crates.io"),I=e(". If you have Rust installed you can install it using "),S=t("code",null,"cargo install nu",-1),O=e("."),z=o('<p>If you want all the built-in goodies, you can install <code>cargo install nu --all-features</code>.</p><p>As part of this release, we also publish a set of optional plugins you can install and use with Nu. To install, use <code>cargo install nu_plugin_&lt;plugin name&gt;</code>.</p><h1 id="party-\u{1F973}" tabindex="-1"><a class="header-anchor" href="#party-\u{1F973}" aria-hidden="true">#</a> Party! \u{1F973}</h1><p>It&#39;s here! \u{1F389}\u{1F389}</p><p>We&#39;re excited to announce the first full release of Nushell using the new engine, new line editor, and so much more!</p><h1 id="skipping-versions" tabindex="-1"><a class="header-anchor" href="#skipping-versions" aria-hidden="true">#</a> Skipping versions</h1><p>The first thing you&#39;ll notice is that we&#39;re skipping from version 0.44 to 0.60. This is on purpose, you didn&#39;t miss anything!</p><p>Because of the number of changes, and the number of breaking changes, we wanted to let everyone know how much has changed by also making a big jump in the version number. Previous scripts will need to be updated, and you&#39;ll need to learn some of the new ways of doing things in Nushell to get back to your same level of comfort.</p><p>Let&#39;s talk about the features new in this release.</p><h1 id="custom-completions" tabindex="-1"><a class="header-anchor" href="#custom-completions" aria-hidden="true">#</a> Custom completions</h1><p><img src="'+l+`" alt="Custom completions for git and winget"></p><p>Let&#39;s start with Nushell&#39;s most-requested feature: custom completions. The long-awaited, long-requested feature of having nice completions is finally here. With 0.60, you&#39;ll be able to write scripts that help you complete parameters and flag values. Let&#39;s take a look at an example. When you create a new config, you&#39;ll see a section like this:</p><div class="language-text ext-text"><pre class="language-text"><code># This is a simplified version of completions for git branches and git remotes
...
\u2502 85 \u2502 \u0218tefan                          \u2502
\u2570\u2500\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u256F
</code></pre></div><h1 id="looking-ahead" tabindex="-1"><a class="header-anchor" href="#looking-ahead" aria-hidden="true">#</a> Looking ahead</h1><p>With 0.60, we have a solid foundation to build on to reach 1.0. The cleaner architecture and improvements to the language will make way for future improvements, like pattern matching, tasks, and more.</p>`,5);function he(ue,pe){const a=d("ExternalLinkIcon");return s(),i("div",null,[t("p",null,[t("em",null,[b,t("a",y,[v,n(a)]),x])]),_,k,N,q,t("p",null,[T,t("a",$,[A,n(a)]),B,t("a",M,[W,n(a)]),I,S,O]),z,t("p",null,[C,t("a",E,[L,n(a)]),R]),D,t("p",null,[P,t("a",Y,[F,n(a)]),G,t("a",j,[H,n(a)]),J]),U,t("p",null,[V,t("a",K,[Z,n(a)]),X]),Q,ee,t("p",null,[te,t("a",ae,[ne,n(a)]),oe]),re,t("p",null,[se,t("a",ie,[de,n(a)]),le]),ce])}var me=r(w,[["render",he],["__file","2022-03-22-nushell_0_60.html.vue"]]);export{me as default};
