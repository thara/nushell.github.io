...
----+---------------+------+----------+---------+------------+------------
</code></pre></div><p>Ahora podemos comparar los dos para verificar si faltan complementos adicionales o si hay complementos adicionales que necesitemos agregar a nuestro archivo &quot;Cargo.toml&quot; (\xA1y claramente falta agregarlo a &quot;Cargo.toml&quot;!)</p>`,16);function v(b,x){const o=d("RouterLink");return n(),t("div",null,[u,r("p",null,[m,l(o,{to:"/es/book/plugins.html"},{default:i(()=>[p]),_:1}),g]),h])}const q=s(c,[["render",v],["__file","shells_en_shells.html.vue"]]);export{q as default};
