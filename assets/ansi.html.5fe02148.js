import{_ as t,o,c as r,a as e,t as a,d as s,e as c}from"./app.fbc72659.js";const i={},l={id:"frontmatter-title-for-platform",tabindex:"-1"},p=e("a",{class:"header-anchor",href:"#frontmatter-title-for-platform","aria-hidden":"true"},"#",-1),d=s(),u=s(" for platform"),h={style:{"white-space":"pre-wrap","margin-top":"10px"}},g=c(`<h2 id="signature" tabindex="-1"><a class="header-anchor" href="#signature" aria-hidden="true">#</a> Signature</h2><p><code>&gt; ansi (code) --escape --osc --list</code></p><h2 id="parameters" tabindex="-1"><a class="header-anchor" href="#parameters" aria-hidden="true">#</a> Parameters</h2><ul><li><code>code</code>: the name of the code to use like &#39;green&#39; or &#39;reset&#39; to reset the color</li><li><code>--escape</code>: escape sequence without the escape character(s)</li><li><code>--osc</code>: operating system command (ocs) escape sequence without the escape character(s)</li><li><code>--list</code>: list available ansi code names</li></ul><h2 id="notes" tabindex="-1"><a class="header-anchor" href="#notes" aria-hidden="true">#</a> Notes</h2><div class="language-text ext-text"><pre class="language-text"><code>For escape sequences:
...
</code></pre></div>`,17);function b(n,m){return o(),r("div",null,[e("h1",l,[p,d,e("code",null,a(n.$frontmatter.title),1),u]),e("div",h,a(n.$frontmatter.platform),1),g])}const f=t(i,[["render",b],["__file","ansi.html.vue"]]);export{f as default};
