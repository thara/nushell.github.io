...
<span class="token punctuation">}</span>
</code></pre></div><p>\u5728\u4E0A\u9762\u7684<code>greet</code>\u5B9A\u4E49\u4E2D\uFF0C\u6211\u4EEC\u5B9A\u4E49\u4E86<code>name</code>\u4F4D\u7F6E\u53C2\u6570\u4EE5\u53CA<code>age</code>\u6807\u5FD7\u3002\u8FD9\u5141\u8BB8<code>greet</code>\u7684\u8C03\u7528\u8005\u4E5F\u53EF\u4EE5\u9009\u62E9\u4F20\u9012<code>age</code>\u53C2\u6570\u3002</p><p>\u4F60\u53EF\u4EE5\u7528\u4EE5\u4E0B\u65B9\u6CD5\u8C03\u7528\u4E0A\u8FF0\u5185\u5BB9\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> greet world --age <span class="token number">10</span>
</code></pre></div><p>\u6216\u8005\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> greet --age <span class="token number">10</span> world
  ...
  name: string
  --age <span class="token punctuation">(</span>-a<span class="token punctuation">)</span>: int
<span class="token punctuation">]</span> <span class="token punctuation">{</span>
  <span class="token builtin class-name">echo</span> <span class="token variable">$name</span> <span class="token variable">$age</span>
<span class="token punctuation">}</span>
...
def greet <span class="token punctuation">[</span>
  ...
  --age <span class="token punctuation">(</span>-a<span class="token punctuation">)</span>: int   <span class="token comment"># The age of the person</span>
<span class="token punctuation">]</span> <span class="token punctuation">{</span>
  <span class="token builtin class-name">echo</span> <span class="token variable">$name</span> <span class="token variable">$age</span>
<span class="token punctuation">}</span>
...
\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500\u2500
  ...
  <span class="token variable">$cols</span> <span class="token operator">|</span> reduce --fold <span class="token variable">$start</span> <span class="token punctuation">{</span> <span class="token operator">|</span>col, <span class="token function">df</span><span class="token operator">|</span>
    <span class="token variable">$df</span> <span class="token operator">|</span> upsert <span class="token variable">$col</span> null
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="\u6301\u4E45\u5316" tabindex="-1"><a class="header-anchor" href="#\u6301\u4E45\u5316" aria-hidden="true">#</a> \u6301\u4E45\u5316</h2>`,11),f=a("\u5173\u4E8E\u5982\u4F55\u6301\u4E45\u5316\u81EA\u5B9A\u4E49\u547D\u4EE4\uFF0C\u4EE5\u4FBF\u5728\u4F60\u542F\u52A8 Nushell \u65F6\u5B83\u4EEC\u662F\u53EF\u7528\u7684\uFF0C\u8BF7\u53C2\u9605 "),_=a("\u914D\u7F6E"),$=a(" \u90E8\u5206\u5E76\u6DFB\u52A0\u4F60\u7684\u542F\u52A8\u811A\u672C\u3002");function q(y,w){const s=i("RouterLink");return c(),l("div",null,[u,n("p",null,[r,e(s,{to:"/book/commands/ls.html"},{default:t(()=>[g]),_:1}),h]),k,n("p",null,[m,e(s,{to:"/book/commands/ls.html"},{default:t(()=>[b]),_:1}),v]),x,n("p",null,[f,e(s,{to:"/zh-CN/book/configuration.html"},{default:t(()=>[_]),_:1}),$])])}var B=p(d,[["render",q],["__file","custom_commands.html.vue"]]);export{B as default};
