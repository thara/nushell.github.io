import{_ as n,r as s,o as i,c as l,a as e,b as o,d as a,e as r}from"./app.d3abc44b.js";const d={},c=e("h1",{id:"nushell-0-25",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#nushell-0-25","aria-hidden":"true"},"#"),a(" Nushell 0.25")],-1),h=e("p",null,"Nushell, or Nu for short, is a new shell that takes a modern, structured approach to your commandline. It works seamlessly with the data from your filesystem, operating system, and a growing number of file formats to make it easy to build powerful commandline pipelines.",-1),u=e("p",null,"Today, we're releasing 0.25 of Nu. It's one of the largest releases we've ever done. With it Nushell grows from being a shell to being a full scripting language as well.",-1),p=e("h1",{id:"where-to-get-it",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#where-to-get-it","aria-hidden":"true"},"#"),a(" Where to get it")],-1),g=a("Nu 0.25 is available as "),m={href:"https://github.com/nushell/nushell/releases/tag/0.25.1",target:"_blank",rel:"noopener noreferrer"},f=a("pre-built binaries"),x=a(" or from "),_={href:"https://crates.io/crates/nu",target:"_blank",rel:"noopener noreferrer"},b=a("crates.io"),w=a(". If you have Rust installed you can install it using "),v=e("code",null,"cargo install nu",-1),y=a("."),k=e("p",null,[a("If you want all the goodies, you can install "),e("code",null,"cargo install nu --features=extra"),a(".")],-1),N=e("p",null,[a("As part of this release, we also publish a set of plugins you can install and use with Nu. To install, use "),e("code",null,"cargo install nu_plugin_<plugin name>"),a(".")],-1),q=e("h1",{id:"what-s-new",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#what-s-new","aria-hidden":"true"},"#"),a(" What's New")],-1),T=a("Lots of new features in this release. If you'd like to watch a demonstration, we can also watch a "),$={href:"https://www.youtube.com/watch?v=PO6EW7_a1tE",target:"_blank",rel:"noopener noreferrer"},E=a("video showing off the new features"),I=a("."),W=r(`<h2 id="custom-commands" tabindex="-1"><a class="header-anchor" href="#custom-commands" aria-hidden="true">#</a> Custom commands</h2><p>A long-requested feature for Nushell is to have scripting capability. A key piece of this story is the ability to make your own commands in addition to those built into Nu.</p><p>With 0.25, you can now make your own custom commands:</p><div class="language-text ext-text"><pre class="language-text"><code>def add [x, y] {
    = $x + $y
}
...
</code></pre></div><p>Calling <code>mycmd 1 2</code> now expands to <code>myverylongcommand 1 2</code> and then runs the expanded command.</p><h2 id="improvements" tabindex="-1"><a class="header-anchor" href="#improvements" aria-hidden="true">#</a> Improvements</h2>`,48),A=e("li",null,[a("the "),e("code",null,"which"),a(" command now shows if the name points to an alias or custom command (LhKipp)")],-1),L=a("you can configure the "),z={href:"https://github.com/nushell/nushell/pull/2829",target:"_blank",rel:"noopener noreferrer"},B=a("style that primities are shown"),C=a(" (fdncred)"),V=a("optionally you can "),Y={href:"https://github.com/nushell/nushell/pull/2794",target:"_blank",rel:"noopener noreferrer"},P=a("highlight trailing spaces"),R=a(" (fdncred)"),J=e("li",null,[a("we support comments now, using "),e("code",null,"#"),a(" (jonathandturner)")],-1),K=e("li",null,[a("better information for debugging in "),e("code",null,"version"),a(" (gillespiecd)")],-1),O=e("li",null,"Thanks to all those who landed general improvements too! (baoyachi, scrabsha, stormasm, max-sixty, ArturKovacs, JosephTLyons)",-1),S=e("h1",{id:"looking-forward",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#looking-forward","aria-hidden":"true"},"#"),a(" Looking forward")],-1),j=e("p",null,"This update opens a lot of doors to what's possible with Nushell. There are a few areas we'd like to explore with it: better autocompletions, describing external commands, and more. We'd also really like to hear your feedback on the release so we can continue to improve the overall experience of using Nu.",-1);function H(D,F){const t=s("ExternalLinkIcon");return i(),l("div",null,[c,h,u,p,e("p",null,[g,e("a",m,[f,o(t)]),x,e("a",_,[b,o(t)]),w,v,y]),k,N,q,e("p",null,[T,e("a",$,[E,o(t)]),I]),W,e("ul",null,[A,e("li",null,[L,e("a",z,[B,o(t)]),C]),e("li",null,[V,e("a",Y,[P,o(t)]),R]),J,K,O]),S,j])}var M=n(d,[["render",H],["__file","2021-01-05-nushell_0_25.html.vue"]]);export{M as default};
