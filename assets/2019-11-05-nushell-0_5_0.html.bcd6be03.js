import{_ as t,r as o,o as r,c as l,a,b as s,d as n,e as p}from"./app.dffb4375.js";const c={},i=a("h1",{id:"nushell-0-5-0",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#nushell-0-5-0","aria-hidden":"true"},"#"),n(" Nushell 0.5.0")],-1),h=a("p",null,"Nushell, or Nu for short, is a new shell that takes a modern, structured approach to your commandline. It works seamlessly with the data from your filesystem, operating system, and a growing number of file formats to make it easy to build powerful commandline pipelines.",-1),d=a("p",null,"Today, we're happy to announce the 0.5.0 release for Nu. We've got lots of new features, including some long-requested ones, in this release.",-1),u=a("h1",{id:"where-to-get-it",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#where-to-get-it","aria-hidden":"true"},"#"),n(" Where to get it")],-1),g=n("Nu 0.5.0 is available as "),m={href:"https://github.com/nushell/nushell/releases/tag/0_5_0",target:"_blank",rel:"noopener noreferrer"},b=n("pre-built binaries"),k=n(" or from "),f={href:"https://crates.io/crates/nu",target:"_blank",rel:"noopener noreferrer"},v=n("crates.io"),_=n(". If you have Rust installed you can install it using "),w=a("code",null,"cargo +beta install nu",-1),y=n(" (or if you want all the features "),x=a("code",null,"cargo +beta install nu --all-features",-1),N=n(")."),j=p(`<h1 id="nu-as-a-login-shell-jonathandturner" tabindex="-1"><a class="header-anchor" href="#nu-as-a-login-shell-jonathandturner" aria-hidden="true">#</a> Nu as a login shell (jonathandturner)</h1><p>One of the key features that landed in 0.5.0 is set of new capabilities that work together to allow you to use Nu as a login shell, completely independent of bash or other hosting shells. For this, we&#39;ve built in support for querying and updating the environment variables and the path.</p><p>To get started, you&#39;ll need to first copy the environment you&#39;re using into the config. Luckily, we&#39;ve also made some improvements there:</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> config --set <span class="token punctuation">[</span>path <span class="token variable">$nu</span>:path<span class="token punctuation">]</span>
<span class="token operator">&gt;</span> config --set <span class="token punctuation">[</span>env <span class="token variable">$nu</span>:env<span class="token punctuation">]</span>
...
</code></pre></div><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token function">ls</span> <span class="token operator">|</span> get name <span class="token operator">|</span> str --substring <span class="token string">&quot;0,3&quot;</span>
\u2501\u2501\u2501\u2501\u252F\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
 <span class="token comment">#  \u2502 &lt;value&gt;</span>
\u2500\u2500\u2500\u2500\u253C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
