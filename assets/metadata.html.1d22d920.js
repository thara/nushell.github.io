...
\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500
`)])],-1),v=e("p",null,`The span "start" and "end" here refer to where the underline will be in the line. If you count over 5, and then count up to 15, you'll see it lines up with the "Cargo.toml" filename. This is how the error we saw earlier knew what to underline.`,-1);function y(b,C){const o=i("RouterLink");return n(),s("div",null,[c,d,u,m,g,e("p",null,[p,l(o,{to:"/book/commands/open.html"},{default:r(()=>[_]),_:1}),f]),w,x,k,v])}const T=a(h,[["render",y],["__file","metadata.html.vue"]]);export{T as default};
