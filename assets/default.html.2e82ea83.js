import{_ as a,o as n,c as e,e as s}from"./app.aeb1065a.js";const o={},t=s(`<p>This command sets a default row&#39;s column if missing. Other commands are capable of feeding <code>default</code> with their output through pipelines.</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token punctuation">[</span>input-command<span class="token punctuation">]</span> <span class="token operator">|</span> default <span class="token punctuation">[</span>column-name<span class="token punctuation">]</span> <span class="token punctuation">[</span>column-value<span class="token punctuation">]</span>
