import{_ as s,o as t,c as o,a as e,t as a,d as r,e as c}from"./app.79ccc45b.js";const i={},l={id:"frontmatter-title",tabindex:"-1"},p=e("a",{class:"header-anchor",href:"#frontmatter-title","aria-hidden":"true"},"#",-1),d=r(),u={style:{"white-space":"pre-wrap"}},h=c(`<h2 id="signature" tabindex="-1"><a class="header-anchor" href="#signature" aria-hidden="true">#</a> Signature</h2><p><code>&gt; ansi (code) --escape --osc --list</code></p><h2 id="parameters" tabindex="-1"><a class="header-anchor" href="#parameters" aria-hidden="true">#</a> Parameters</h2><ul><li><code>code</code>: the name of the code to use like &#39;green&#39; or &#39;reset&#39; to reset the color</li><li><code>--escape</code>: escape sequence without the escape character(s)</li><li><code>--osc</code>: operating system command (ocs) escape sequence without the escape character(s)</li><li><code>--list</code>: list available ansi code names</li></ul><h2 id="notes" tabindex="-1"><a class="header-anchor" href="#notes" aria-hidden="true">#</a> Notes</h2><div class="language-text ext-text"><pre class="language-text"><code>For escape sequences:
...
</code></pre></div><p>Use ansi to color text (italic bright yellow on red &#39;Hello&#39; with green bold &#39;Nu&#39; and purple bold &#39;World&#39;)</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token builtin class-name">echo</span> <span class="token punctuation">[</span><span class="token punctuation">(</span>ansi -e <span class="token string">&#39;3;93;41m&#39;</span><span class="token punctuation">)</span> Hello <span class="token punctuation">(</span>ansi reset<span class="token punctuation">)</span> <span class="token string">&quot; &quot;</span> <span class="token punctuation">(</span>ansi gb<span class="token punctuation">)</span> Nu <span class="token string">&quot; &quot;</span> <span class="token punctuation">(</span>ansi pb<span class="token punctuation">)</span> World <span class="token punctuation">(</span>ansi reset<span class="token punctuation">)</span><span class="token punctuation">]</span> <span class="token operator">|</span> str collect
...
</code></pre></div>`,17);function g(n,b){return t(),o("div",null,[e("h1",l,[p,d,e("code",null,a(n.$frontmatter.title),1)]),e("div",u,a(n.$frontmatter.usage),1),h])}var m=s(i,[["render",g],["__file","ansi.html.vue"]]);export{m as default};
