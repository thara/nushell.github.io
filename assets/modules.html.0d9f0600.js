...
</code></pre></div><p>or in a file named the same as the the module you want to create:</p><div class="language-text ext-text"><pre class="language-text"><code># greetings.nu
