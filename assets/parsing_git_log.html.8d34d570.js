import{_ as a,o as n,c as s,e}from"./app.2d85966f.js";const o={},t=e(`<h1 id="parsing-git-log" tabindex="-1"><a class="header-anchor" href="#parsing-git-log" aria-hidden="true">#</a> Parsing Git Log</h1><h1 id="let-s-parse-git-log" tabindex="-1"><a class="header-anchor" href="#let-s-parse-git-log" aria-hidden="true">#</a> Let&#39;s parse git log</h1><p>This <code>git log</code> command is interesting but you can&#39;t do a lot with it like this.</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token function">git</span> log
