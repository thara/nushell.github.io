...
`)])],-1),k=e("p",null,[o("We'll use this module throughout the chapter: Whenever you see "),e("code",null,"overlay add spam"),o(", assume "),e("code",null,"spam"),o(" is referring to this module.")],-1),T=o("To create the overlay, call "),q=e("code",null,"overlay add",-1),O=o(":"),N=e("div",{class:"language-text ext-text"},[e("pre",{class:"language-text"},[e("code",null,`> overlay add spam
...
\u2500\u2500\u2500\u252C\u2500\u2500\u2500\u2500\u2500\u2500
 ...
 1 \u2502 spam
\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500\u2500\u2500
`)])],-1),B=e("p",null,[o("In the following sections, the "),e("code",null,">"),o(" prompt will be preceded by the name of the last active overlay. "),e("code",null,"(spam)> some-command"),o(" means the "),e("code",null,"spam"),o(" overlay is the last active overlay when the command was typed.")],-1),I=e("h2",{id:"removing-an-overlay",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#removing-an-overlay","aria-hidden":"true"},"#"),o(" Removing an Overlay")],-1),R=o("If you don't need the overlay definitions anymore, call "),A=e("code",null,"overlay remove",-1),C=o(":"),P=e("div",{class:"language-text ext-text"},[e("pre",{class:"language-text"},[e("code",null,`(spam)> overlay remove spam
...
\u2500\u2500\u2500\u252C\u2500\u2500\u2500\u2500\u2500\u2500
 0 \u2502 zero
\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500\u2500\u2500
`)])],-1),V=e("p",null,"The overlays are also scoped. Any added overlays are removed at the end of the scope:",-1),E=e("div",{class:"language-text ext-text"},[e("pre",{class:"language-text"},[e("code",null,`(zero)> do { overlay add spam; foo }
foo
...
`)])],-1),H=e("p",null,[o("The "),e("code",null,"eggs"),o(" command is added into "),e("code",null,"scratchpad"),o(" while keeping "),e("code",null,"spam"),o(" intact.")],-1),M=o("To make it less verbose, you can use the "),$=e("code",null,"overlay new",-1),G=o(" command:"),J=e("div",{class:"language-text ext-text"},[e("pre",{class:"language-text"},[e("code",null,`(zero)> overlay add spam
...
\u2500\u2500\u2500\u252C\u2500\u2500\u2500\u2500\u2500\u2500
 ...
 1 \u2502 zero
\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500\u2500\u2500
</code></pre></div><p>Now, the <code>zero</code> overlay takes a precedence.</p>`,15);function Q(U,X){const a=c("RouterLink");return r(),l("div",null,[h,u,e("p",null,[e("em",null,[m,t(a,{to:"/book/modules.html"},{default:n(()=>[v]),_:1}),g])]),p,e("p",null,[y,_,f,t(a,{to:"/book/commands/overlay_list.html"},{default:n(()=>[x]),_:1}),b]),w,z,k,e("p",null,[T,t(a,{to:"/book/commands/overlay_add.html"},{default:n(()=>[q]),_:1}),O]),N,B,I,e("p",null,[R,t(a,{to:"/book/commands/overlay_remove.html"},{default:n(()=>[A]),_:1}),C]),P,V,E,e("p",null,[S,t(a,{to:"/book/commands/overlay_remove.html"},{default:n(()=>[Y]),_:1}),F]),L,e("div",W,[Z,j,D,H,e("p",null,[M,t(a,{to:"/book/commands/overlay_new.html"},{default:n(()=>[$]),_:1}),G]),J]),K])}var oe=d(i,[["render",Q],["__file","overlays.html.vue"]]);export{oe as default};
