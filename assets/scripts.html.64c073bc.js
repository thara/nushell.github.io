...
Hello World!
`)])],-1);function V(W,U){const s=a("RouterLink"),d=a("ExternalLinkIcon");return l(),c("div",null,[h,p,g,e("p",null,[_,m,f,t(s,{to:"/book/commands/source.html"},{default:i(()=>[k]),_:1}),x]),w,e("p",null,[b,v,S,z,B,t(s,{to:"/de/book/types_of_data.html#groups"},{default:i(()=>[D]),_:1}),N]),q,e("p",null,[y,e("a",A,[I,t(d)]),E,L,R]),C,H])}var M=o(u,[["render",V],["__file","scripts.html.vue"]]);export{M as default};
