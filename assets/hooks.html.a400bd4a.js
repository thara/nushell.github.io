...
</code></pre></div>`,24);function S(C,I){const s=r("ExternalLinkIcon"),a=r("RouterLink");return d(),h("div",null,[p,o("p",null,[g,o("a",u,[f,n(s)]),v,m,_,k,x]),b,o("p",null,[y,n(a,{to:"/book/configuration.html"},{default:i(()=>[w]),_:1}),$]),q,o("p",null,[P,T,W,n(a,{to:"/book/environment.html#defining-environment-from-custom-commands"},{default:i(()=>[D]),_:1}),E]),A])}const N=c(l,[["render",S],["__file","hooks.html.vue"]]);export{N as default};
